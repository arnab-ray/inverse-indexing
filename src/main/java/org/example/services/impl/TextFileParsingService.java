...
public class TextFileParsingService implements FileParsingService {

    private TextFileParsingService() {}

    private static class SingletonHelper {
        private static final TextFileParsingService INSTANCE = new TextFileParsingService();
    }

    public static TextFileParsingService getInstance() {
